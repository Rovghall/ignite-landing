/** Native JA posts 1–10 */
export const jaPosts1_10 = {
  'calorie-tracker-without-subscription-2026': {
    ...
    sections: [
      ...
      { heading: '買い切りの神話', body: ['買い切りは完璧に聞こえますが、DB が古くなり、OS 変更でスキャナが壊れ、「 lifetime 」がクラウド同期を含まない——あり得ます。実際の包含を確認してください。', '更新を出す公正なサブが、6ヶ月で使い古す買い切りより健全なこともあります。'] },
      ...
      { heading: 'まとめ', body: ['食事が無料ツールに合い代償を受け入れなら2026もサブスクなし可能。全機能無料 AI 写真が広くあるとは想定しない。', 'ワークフローが持つなら無料；混合食ログ完了が実際の赤字のボトルネックなら IGNITE AI Premium。'] },
    ],
  },
};
