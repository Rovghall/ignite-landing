...
export const nl = {
  ...
  footer: {
    ...
    referralTerms: "Voorwaarden referralprogramma",
  ...
  creatorProgram: {
    ...
    subtitle:
      "Word partner van IGNITE AI. Deel je persoonlijke code voor de exclusieve jaarprijs en verdien geld wanneer je publiek Premium neemt.",
    heroAlt: 'Creators rond de IGNITE AI-vlam',
    howTitle: 'Hoe het werkt',
    steps: [
      {
        title: 'Download de app',
        description: 'Installeer IGNITE AI via de App Store of Google Play en maak je account aan.',
      },
      {
        title: 'Solliciteer in de app',
        description: 'Open Profiel → Creator program → Apply met je social profiles en audience-details.',
      },
      {
        title: 'Wij beoordelen',
        description: 'Ons team bekijkt je profiel en laat iets weten wanneer er een beslissing is.',
      },
      {
        title: 'Deel en verdien',
        description:
          "Bij goedkeuring krijg je een persoonlijke creator-code voor de laagste jaarlijkse Premium-prijs. Verdien geld voor elk jaarlijks Premium-abonnement met jouw code. Meer info in de app.",
      },
    ],
    ctaTitle: 'Solliciteer in de app',
    ctaSubtitle:
      "Aanmeldingen gebeuren in IGNITE AI zodat je creator-account, code en complimentary Premium aan jou gekoppeld blijven. Download de app voor de beloningsdetails.",
    ctaSteps: [
      'Download IGNITE AI',
      'Open Profiel → Creator program',
      'Tik op Apply',
    ],
    termsLink: "Voorwaarden Creator Program",
  },
  blog: {
    title: 'Onze blog',
