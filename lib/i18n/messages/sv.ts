...
export const sv = {
  ...
  footer: {
    ...
    referralTerms: "Villkor för referralprogrammet",
  ...
  creatorProgram: {
    ...
    subtitle:
      "Bli partner med IGNITE AI. Dela din personliga kod för det exklusiva årspriset och tjäna pengar när din publik går Premium.",
    heroAlt: 'Creators samlade runt IGNITE AI-flamman',
    howTitle: 'Så funkar det',
    steps: [
      {
        title: 'Ladda ner appen',
        description: 'Installera IGNITE AI från App Store eller Google Play och skapa ditt konto.',
      },
      {
        title: 'Ansök i appen',
        description: 'Öppna Profil → Creator program → Apply med dina sociala profiler och publikdetaljer.',
      },
      {
        title: 'Vi granskar',
        description: 'Vårt team tittar på din profil och återkommer när ett beslut är klart.',
      },
      {
        title: 'Dela och tjäna',
        description:
          "Om du godkänns får du en personlig creator-kod för det lägsta årliga Premium-priset. Tjäna pengar för varje årligt Premium-abonnemang med din kod. Ladda ner appen för mer info.",
      },
    ],
    ctaTitle: 'Ansök i appen',
    ctaSubtitle:
      "Ansökningar sker i IGNITE AI så att ditt creator-konto, kod och complimentary Premium förblir kopplade till dig. Ladda ner appen för belöningsdetaljer.",
    ctaSteps: [
      'Ladda ner IGNITE AI',
      'Öppna Profil → Creator program',
      'Tryck Apply',
    ],
    termsLink: "Villkor för Creator Program",
  },
  blog: {
    title: 'Vår blogg',
