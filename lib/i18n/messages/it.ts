...
export const it = {
  ...
  footer: {
    ...
    referralTerms: "Termini del programma referral",
    creatorProgramTerms: "Termini del Creator Program",
    company: 'Azienda',
    contact: 'Contatti',
    faq: 'FAQ',
    creatorProgram: 'Creator Program',
  ...
  creatorProgram: {
    ...
    heroAlt: 'Creator uniti intorno alla fiamma IGNITE AI',
    howTitle: 'Come funziona',
    steps: [
      {
        title: "Scarica l'app",
        description: 'Installa IGNITE AI su App Store o Google Play e crea il tuo account.',
      },
      {
        title: "Candidati nell'app",
        description: 'Apri Profilo → Creator program → Apply con i tuoi profili social e i dettagli del pubblico.',
      },
      {
        title: 'Esaminamo',
        description: "Il nostro team esamina il tuo profilo e ti risponde quando c'è una decisione.",
      },
      {
        title: 'Condividi e guadagna',
        description:
          "Se sei approvato, ricevi un codice creator personalizzato al prezzo annuale Premium più basso. Guadagna per ogni abbonamento Premium annuale con il tuo codice. Per maggiori info, scarica l'app.",
      },
    ],
    ctaTitle: "Candidati nell'app",
    ctaSubtitle:
      "Le candidature avvengono in IGNITE AI così account creator, codice e Premium gratuito restano collegati a te. Scarica l'app per i dettagli delle ricompense.",
    ctaSteps: [
      'Scarica IGNITE AI',
      'Apri Profilo → Creator program',
      'Tocca Apply',
    ],
  ...
  blog: {
    ...
    previous: 'Precedente',
    next: 'Successivo',
    paginationLabel: 'Pagine del blog',
  },
  legal: {
    backHome: '← Home',
    related: 'Correlati:',
  ...
  faq: faqIt,
  store: {
    appStoreSoonTitle: "Presto sull’App Store",
    appStoreSoonBody:
      "IGNITE AI per iOS sarà presto disponibile sull’App Store. Puoi già scaricare l’app Android su Google Play.",
    gotIt: "Capito",
  },
  comingSoon: {
    title: "Prossimamente",
