...
export const ko = {
  ...
  creatorProgram: {
    ...
    subtitle:
      "IGNITE AI와 함께하세요. 독점 연간 요금 코드를 공유하고 오디언스가 Premium을 구독하면 수익을 얻으세요.",
    heroAlt: 'IGNITE AI 불꽃 주변의 크리에이터들',
    howTitle: '이용 방법',
    steps: [
      {
        title: '앱 다운로드',
        description: 'App Store 또는 Google Play에서 IGNITE AI를 설치하고 계정을 만드세요.',
      },
      {
        title: '앱에서 지원',
        description: '프로필 → Creator program → Apply에서 소셜 프로필과 오디언스 정보를 제출하세요.',
      },
      {
        title: '검토',
        description: '팀이 프로필을 검토하고 결정이 나면 연락드립니다.',
      },
      {
        title: '공유하고 적립',
        description:
          "승인되면 최저 연간 Premium 가격의 크리에이터 코드를 받습니다. 코드로 연간 Premium을 구독할 때마다 수익을 얻습니다. 자세한 내용은 앱을 다운로드하세요.",
      },
    ],
    ctaTitle: '앱에서 지원하기',
    ctaSubtitle:
      "지원은 IGNITE AI 앱 안에서 이루어져 크리에이터 계정, 코드, 무료 Premium이 당신과 연결됩니다. 보상 세부 사항은 앱에서 확인하세요.",
    ctaSteps: [
      'IGNITE AI 다운로드',
      '프로필 → Creator program 열기',
      'Apply 탭',
    ],
