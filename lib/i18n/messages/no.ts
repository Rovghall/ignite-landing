...
export const no = {
  ...
  footer: {
    ...
    referralTerms: "Vilkår for henvisningsprogrammet",
  ...
  creatorProgram: {
    ...
    subtitle:
      "Bli partner med IGNITE AI. Del din personlige kode for eksklusiv årspris og tjen penger når publikumet ditt går Premium.",
    heroAlt: 'Skapere samlet rundt IGNITE AI-flammen',
    howTitle: 'Slik fungerer det',
    steps: [
      {
        title: 'Last ned appen',
        description: 'Installer IGNITE AI fra App Store eller Google Play og opprett kontoen din.',
      },
      {
        title: 'Søk i appen',
        description: 'Åpne Profil → Creator program → Apply med sosiale profiler og publikumdetaljer.',
      },
      {
        title: 'Vi vurderer',
        description: 'Teamet vårt ser på profilen din og svarer når en beslutning er klar.',
      },
      {
        title: 'Del og tjen',
        description:
          "Hvis du blir godkjent, får du en personlig creator-kode for laveste årlige Premium-pris. Tjen penger for hvert årlig Premium-abonnement med koden din. Last ned appen for mer info.",
      },
    ],
    ctaTitle: 'Søk i appen',
    ctaSubtitle:
      "Søknader skjer inne i IGNITE AI slik at creator-konto, kode og gratis Premium forblir knyttet til deg. Last ned appen for belønningsdetaljer.",
    ctaSteps: [
      'Last ned IGNITE AI',
      'Åpne Profil → Creator program',
      'Trykk Apply',
    ],
    termsLink: "Vilkår for Creator Program",
  },
  blog: {
    title: 'Bloggen vår',
