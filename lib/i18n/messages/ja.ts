...
export const ja = {
  ...
  creatorProgram: {
    ...
    subtitle:
      "IGNITE AIと提携しましょう。専用の年間プラン料金のコードを共有し、オーディエンスがPremiumになると収益を得られます。",
    heroAlt: 'IGNITE AIの炎を囲むクリエイターたち',
    howTitle: '仕組み',
    steps: [
      {
        title: 'アプリをダウンロード',
        description: 'App StoreまたはGoogle PlayでIGNITE AIをインストールし、アカウントを作成します。',
      },
      {
        title: 'アプリ内で応募',
        description: 'プロフィール → Creator program → Apply からSNSとオーディエンス情報を送ってください。',
      },
      {
        title: '審査',
        description: 'チームがプロフィールを確認し、結果が決まり次第ご連絡します。',
      },
      {
        title: '共有して稼ぐ',
        description:
          "承認されると、最安の年間Premium向けクリエイターコードを受け取れます。コードでの年間Premium登録ごとに収益を得られます。詳細はアプリをダウンロードしてください。",
      },
    ],
    ctaTitle: 'アプリで応募',
    ctaSubtitle:
      "応募はIGNITE AIアプリ内で行うため、クリエイターアカウント・コード・無料Premiumがあなたに紐づきます。報酬の詳細はアプリでご確認ください。",
    ctaSteps: [
      'IGNITE AIをダウンロード',
      'プロフィール → Creator program を開く',
      'Apply をタップ',
    ],
    termsLink: "Creator Program利用規約",
  },
  blog: {
    title: 'ブログ',
    subtitle: '最新情報をフォロー',
