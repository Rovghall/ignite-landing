...
export const ptBr = {
  ...
  footer: {
    ...
    terms: 'Termos de uso',
    referralTerms: "Termos do Programa de Indicação",
  ...
  creatorProgram: {
    ...
    subtitle:
      "Faça parceria com o IGNITE AI. Compartilhe seu código personalizado para o preço anual exclusivo e ganhe dinheiro quando sua audiência assinar o Premium.",
    heroAlt: 'Criadores conectados em torno da chama IGNITE AI',
    howTitle: 'Como funciona',
    steps: [
      {
        title: 'Baixe o app',
        description: 'Instale o IGNITE AI na App Store ou Google Play e crie sua conta.',
      },
      {
        title: 'Candidate-se no app',
        description: 'Abra Perfil → Creator program → Apply com seus perfis sociais e detalhes da audiência.',
      },
      {
        title: 'Nós analisamos',
        description: 'Nossa equipe analisa seu perfil e responde quando houver uma decisão.',
      },
      {
        title: 'Compartilhe e ganhe',
        description:
          "Se aprovado, você recebe um código de criador personalizado com o menor preço anual Premium. Ganhe dinheiro por cada assinatura anual Premium com o seu código. Para mais informações, baixe o app.",
      },
    ],
    ctaTitle: 'Candidate-se no app',
    ctaSubtitle:
      "As candidaturas acontecem dentro do IGNITE AI para sua conta de criador, código e Premium complementar ficarem ligados a você. Baixe o app para os detalhes das recompensas.",
    ctaSteps: [
      'Baixe o IGNITE AI',
      'Abra Perfil → Creator program',
      'Toque em Apply',
    ],
