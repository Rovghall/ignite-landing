...
export const fr = {
  ...
  footer: {
    ...
    creatorProgramTerms: "Conditions du Creator Program",
    company: 'Entreprise',
    contact: 'Contact',
    faq: 'FAQ',
    creatorProgram: 'Creator Program',
  ...
  creatorProgram: {
    ...
    subtitle:
      "Partenaire d'IGNITE AI. Partagez votre code personnalisé pour le tarif annuel exclusif et gagnez de l'argent quand votre audience passe Premium.",
    heroAlt: 'Créateurs réunis autour de la flamme IGNITE AI',
    howTitle: 'Comment ça marche',
    steps: [
      {
        title: "Téléchargez l'app",
        description: "Installez IGNITE AI sur l'App Store ou Google Play et créez votre compte.",
      },
      {
        title: "Postulez dans l'app",
        description: "Ouvrez Profil → Creator program → Apply avec vos profils sociaux et détails d'audience.",
      },
      {
        title: 'Nous examinons',
        description: 'Notre équipe examine votre profil et vous répond quand une décision est prête.',
      },
      {
        title: 'Partagez et gagnez',
        description:
          "Si vous êtes approuvé, vous recevez un code créateur personnalisé au prix annuel Premium le plus bas. Gagnez de l'argent pour chaque abonnement Premium annuel avec votre code. Pour plus d'infos, téléchargez l'app.",
      },
    ],
    ctaTitle: "Postulez dans l'app",
    ctaSubtitle:
      "Les candidatures se font dans IGNITE AI pour que votre compte créateur, code et Premium offert restent liés à vous. Téléchargez l'app pour le détail des récompenses.",
    ctaSteps: [
      'Téléchargez IGNITE AI',
      'Ouvrez Profil → Creator program',
      'Appuyez sur Apply',
    ],
  ...
  faq: faqFr,
  store: {
    appStoreSoonTitle: "Bientôt sur l’App Store",
    appStoreSoonBody:
      "IGNITE AI pour iOS sera bientôt disponible sur l’App Store. Vous pouvez déjà télécharger l’app Android sur Google Play.",
    gotIt: "Compris",
  },
  comingSoon: {
