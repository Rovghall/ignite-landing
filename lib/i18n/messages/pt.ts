...
export const pt = {
  ...
  footer: {
    ...
    referralTerms: "Termos do Programa de Referral",
  ...
  creatorProgram: {
    ...
    subtitle:
      "Faz parceria com o IGNITE AI. Partilha o teu código personalizado para o preço anual exclusivo e ganha dinheiro quando a tua audiência passa a Premium.",
    heroAlt: 'Criadores ligados em torno da chama IGNITE AI',
    howTitle: 'Como funciona',
    steps: [
      {
        title: 'Descarrega a app',
        description: 'Instala o IGNITE AI na App Store ou Google Play e cria a tua conta.',
      },
      {
        title: 'Candidata-te na app',
        description: 'Abre Perfil → Creator program → Apply com os teus perfis sociais e detalhes da audiência.',
      },
      {
        title: 'Nós analisamos',
        description: 'A nossa equipa analisa o teu perfil e responde-te quando houver decisão.',
      },
      {
        title: 'Partilha e ganha',
        description:
          "Se fores aprovado, recebes um código de criador personalizado com o preço anual Premium mais baixo. Ganha dinheiro por cada inscrição anual Premium com o teu código. Para mais informação, descarrega a app.",
      },
    ],
    ctaTitle: 'Candidata-te na app',
    ctaSubtitle:
      "As candidaturas são feitas dentro do IGNITE AI para a tua conta de criador, código e Premium complementar ficarem ligados a ti. Descarrega a app para os detalhes das recompensas.",
    ctaSteps: [
      'Descarrega o IGNITE AI',
  ...
  blog: {
    ...
    previous: 'Anterior',
    next: 'Seguinte',
    paginationLabel: 'Páginas do blog',
  },
  legal: {
    backHome: '← Início',
    related: 'Relacionado:',
  ...
  store: {
    ...
    appStoreSoonBody:
      "A IGNITE AI para iOS estará disponível na App Store em breve. Já podes descarregar a app Android na Google Play.",
    gotIt: "Percebi",
  },
  comingSoon: {
    title: "Em breve",
